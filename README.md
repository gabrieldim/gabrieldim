...
## For each repository there is an appropriate README file for the application I have developed. For some of them there are Javadocs as well. </br> By default, we can attach six repositories, here are a few more:
